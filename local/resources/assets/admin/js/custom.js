...
function historyVideo(video_id) {
    $.ajax({
        url: url+'/admin/video/history_video/'+video_id,
        method: 'get',
        dataType: 'json',
...
function updateWebsiteInfo(id) {
    $.ajax({
        url: url+'/admin/website_info/get_detail/'+id,
        method: 'get',
        dataType: 'json',
    }).fail(function (ui, status) {
    }).done(function (data, status) {
...
function getMunuChild(id) {
    $.ajax({
        url: url+'/admin/group/form_sort_group/'+id,
        method: 'get',
        dataType: 'json',
    }).fail(function (ui, status) {
    }).done(function (data, status) {
...
function getMunuChildCate(id) {
    $.ajax({
        url: url+'/admin/group/form_sort_group_category/'+id,
        method: 'get',
        dataType: 'json',
    }).fail(function (ui, status) {
    }).done(function (data, status) {
...
function change_status(video_id,status_video) {
    ...
    $.ajax({
        url: url+'/admin/video/update_status/'+video_id,
        method: 'get',
        dataType: 'json',
    }).fail(function (ui, status) {
...
function chang_status_articel(articel_id,atr) {
    $.ajax({
        url: url+'/admin/articel/update_status/' + articel_id + '?status=' + atr.value,
        method: 'get',
        dataType: 'json',
    }).fail(function (ui, status) {
...
function add_menu_video(id) {
    $.ajax({
        url: url+'/admin/group_video/form_group_video/'+id,
        method: 'get',
        dataType: 'json',
    }).fail(function (ui, status) {
    }).done(function (data, status) {
